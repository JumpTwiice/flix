...
class Flix {
  ...
  private val standardLibrary = List(
    ...
    "Fixpoint/Phase/Provenance.flix" -> LocalResource.get("/src/library/Fixpoint/Phase/Provenance.flix"),
    "Fixpoint/Phase/RenamePredSyms.flix" -> LocalResource.get("/src/library/Fixpoint/Phase/RenamePredSyms.flix"),
    ...
    "Fixpoint/AtomicCounter.flix" -> LocalResource.get("/src/library/Fixpoint/AtomicCounter.flix"),
    ...
    "Fixpoint/Boxing.flix" -> LocalResource.get("/src/library/Fixpoint/Boxing.flix"),
    "Fixpoint/BoxingType.flix" -> LocalResource.get("/src/library/Fixpoint/BoxingType.flix"),
    ...
    "Fixpoint/Predicate.flix" -> LocalResource.get("/src/library/Fixpoint/Predicate.flix"),
    ...
    "Fixpoint/Ast/ExecutableRam.flix" -> LocalResource.get("/src/library/Fixpoint/Ast/ExecutableRam.flix"),
