...
class Flix {
  ...
  private val standardLibrary = List(
    ...
    "Fixpoint/Predicates.flix" -> LocalResource.get("/src/library/Fixpoint/Predicates.flix"),
    "Fixpoint/UniqueInts.flix" -> LocalResource.get("/src/library/Fixpoint/UniqueInts.flix"),
    "Fixpoint/BPlusTree.flix" -> LocalResource.get("/src/library/Fixpoint/BPlusTree.flix"),
